...
export function AddEditScreen({ route, navigation }: Props) {
  ...
  // Each section is extracted to a named function so the main return stays
  // scannable. All functions access component state via closure — no props
  // needed.
  ...
  function renderStatusProgressSection() {
    return (
  ...
  function renderNotesMetaSection() {
    return (
    ...
    <View style={[styles.container, { backgroundColor: theme.colors.backgroundPage }]}>
      ...
      >
        ...
        >
          ...
          {renderStatusProgressSection()}

          {/* ── NOTES & META CARD ───────────────────────────────────────────── */}
          {renderNotesMetaSection()}
